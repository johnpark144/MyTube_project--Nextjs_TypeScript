...
function ExpArrowWatchLater({ windowWidth, showAnimations, arrowTimer }: ExpArrowProps) {
  if(!windowWidth){
    windowWidth = 0
  }
  ...
  ${
    ...
    return (
      ...
      ${
        ...
        {/* 오른쪽으로 향하는 점선 */}
        <span
          style={{ top:"255px", left: "99%", marginLeft: "-600px" , fontSize:"3px" }}
          className={classNameFunction("10","1","r",1770,4,5,6,7)}
        >&nbsp;</span>
        <span
          style={{ top:"255px", left: "99%", marginLeft: "-500px", fontSize:"3px" }}
          className={classNameFunction("10","1","r",1660,5,6,7,8)}
        >&nbsp;</span>
        <span
          style={{ top:"255px", left: "99%", marginLeft: "-400px", fontSize:"3px" }}
          className={classNameFunction("10","1","r",1555,6,7,8,9)}
        >&nbsp;</span>
        <span
          style={{ top:"255px", left: "99%", marginLeft: "-300px", fontSize:"3px" }}
          className={classNameFunction("10","1","r",1455,7,8,9,0)}
        >&nbsp;</span>
        <span
          style={{ top:"255px", left: "99%", marginLeft: "-200px", fontSize:"3px" }}
