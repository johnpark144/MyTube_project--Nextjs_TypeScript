...
function ExpArrowHistory({ windowWidth, showAnimations, arrowTimer }: ExpArrowProps) {
  ...
  // 중복된 클래스이름
  const classNameFunction = ( w: string, h: string, toWhere: "r" | "t", windowWidthLimit: number,
   timerNum1: number, timerNum2: number, timerNum3: number, timerNum4: number, timerNum5: number ) => {
  ...
  return (
    <div className="invisible lg:visible">
      ...
      {/* 오른쪽으로 향하는 점선 */}
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-650px", fontSize:"3px" }}
        className={classNameFunction("10", "1", "r", 1770, 3, 4, 5, 6, 7)}
      >&nbsp;</span>
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-550px", fontSize:"3px" }}
        className={classNameFunction("10", "1", "r", 1660, 4, 5, 6, 7, 8)}
      >&nbsp;</span>
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-450px", fontSize:"3px" }}
        className={classNameFunction("10", "1", "r", 1555, 5, 6, 7, 8, 9)}
      >&nbsp;</span>
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-350px", fontSize:"3px" }}
        className={classNameFunction("10", "1", "r", 1455, 6, 7, 8, 9, 10)}
      >&nbsp;</span>
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-250px", fontSize:"3px" }}
        className={classNameFunction("10", "1", "r", 1355, 7, 8, 9, 10, 11)}
      >&nbsp;</span>
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-150px", fontSize:"3px" }}
        className={classNameFunction("10", "1", "r", 1255, 8, 9, 10, 11, 12)}
      >&nbsp;</span>
      <span
        style={{ top: "470px", left: "95%", marginLeft: "-50px", fontSize:"3px" }}
      ...
      <span
        ...
        className={`text-5xl ${classNameFunction("0","0","t",0,1,2,3,4,5)}`}
      >
        <MdArrowUpward />
      </span>
    </div>
